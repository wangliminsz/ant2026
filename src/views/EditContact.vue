      ...
      <div class="row">
        <div class="col-md-4">
          <form @submit.prevent="myUpdate">
            ...
            <div class="mb-2" v-if="contact && contact.fields">
              <input v-model="contact.fields.group_id" type="text" class="form-control" placeholder="Group Id"
                :class="{
                  'is-invalid':
                    contact.fields.group_id && !isValidGroupId,
                }" />
              <div v-if="contact.fields.group_id && !isValidGroupId" class="invalid-feedback">
