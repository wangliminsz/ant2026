                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="mt-3 col-md-6 d-flex justify-content-start">
                                        ...
                                        <button type="button" class="btn btn-outline-secondary btn-md me-2"
                                            @click="handleCancel">
                                            Cancel
                                        </button>
                                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-md-start">
                                    <button type="submit" class="btn btn-outline-dark btn-md me-2"
                                        :disabled="!isValidSearch">
                                        Submit
                                    </button>
                                ...
                                <div class="col-sm-10">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item" style="display: flex; align-items: center;">
                                            <span style="font-size: 0.8em;">Group: {{ contact.fields.group_id }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-1">
                        ...
                        if (response) {
                            ...
                            if (this.searchName === '' || this.searchName == null) {
                                ...
                                const records = contactsCopy.filter(contact =>
                                    contact.fields.name.toLowerCase().includes(this.searchName.toLowerCase())
                                );
